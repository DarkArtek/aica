/*
 * AHD Interactive Cookie Alet for EU Cookie's Law (aka Aica)
 * Plugin for jQuery
 *
 * @author Luca Forzutti
 * @link https//github.com/DarkArt3k
 * @created Apr 14th, 2015
 *
 *Description:
 *  Universal cookie alert plugin, i18n ready, fully customizable
 * Usage:
 *  <script src="vendor/aica/js/aica.js"></script>
 *  <script>aica.init({ <options> })</script>
 */
 var aica = (function($, window, document, namespace, undefined) {
  var
    // Cache objects
    $wrapper,
    $window = $(window),
  ...
  $window.bind('aica-ready', function(){
